...
output "nat_public_ips" {
  description = "Public EIPs of the NAT Gateways (whitelist these in external firewalls)."
...
output "eks_alb_controller_role_arn" {
  description = "IRSA role ARN for the ALB Controller service account annotation."
  value       = module.eks.alb_controller_role_arn
}

output "eks_eso_role_arn" {
  description = "IRSA role ARN for the ESO service account annotation."
...
output "app_irsa_role_arn" {
  description = "IRSA role ARN for the application pods. Annotate the Kubernetes service account with: eks.amazonaws.com/role-arn: <this value>"
